...
import { PaginationDto, handleQueryPagination } from "../utils/pagination.utils";
...
class RestaurantRepository {
  ...
  async createRestaurant(data: createRestaurantDto) {
    ...
    if (!restaurant) throw BadRequestError("Failed To Create Restaurant");
  ...
  async enableOrDisableRestaurant(restaurantId: string) {
    ...
    if (!updatedRestaurant) throw BadRequestError("Failed To Update Restaurant");
  ...
  async deleteRestaurant(restaurantId: string) {
    ...
    if (!deletedRestaurant) throw BadRequestError("Failed To Delete Restaurant");
