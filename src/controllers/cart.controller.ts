...
class CartController {
  async addToCart(req: Request<{}, {}, CreateCartItemDTO>, res: Response) {
  ...
  async removeItem(req: Request<{}, {}, RemoveCartItemDTO>, res: Response) {
    await cartService.removeItem(req.body);
    res
      .status(200)
