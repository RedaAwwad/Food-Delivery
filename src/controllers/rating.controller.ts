...
class RatingController {
    async findRatingsByRestaurantId(req: Request, res: Response, next: NextFunction) {
        ...
        if (!ratings)
            throw BadRequestError('Failed to find ratings');
    ...
    async findRatingByRestaurantIdAndCustomerId(req: Request, res: Response, next: NextFunction) {
        ...
        const rating = await ratingService.findRatingByRestaurantIdAndCustomerId(restaurantId, customerId)
        if (!rating)
            throw BadRequestError('Failed to find rating');
    ...
    async findTopRatedRestaurants(req: Request, res: Response, next: NextFunction) {
        ...
        if (!ratings)
            throw BadRequestError('Failed to find top rated restaurants');
    ...
    async createRatingByCustomer(req: Request, res: Response, next: NextFunction) {
        ...
        const rating = await ratingService.createRatingByCustomer({ customerId, restaurantId, ratingScore, review })
        if (!rating)
            throw BadRequestError('Failed to create rating');
    ...
    async updateRatingByRestaurantIdAndCustomerId(req: Request, res: Response, next: NextFunction) {
        ...
        const rating = await ratingService.updateRatingByRestaurantIdAndCustomerId({ ratingId, customerId, restaurantId, ratingScore, review })
        if (!rating)
